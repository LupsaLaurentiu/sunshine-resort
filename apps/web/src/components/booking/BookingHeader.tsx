...
export function BookingHeader() {
  return (
    <section className="relative flex min-h-[58vh] items-center justify-center overflow-hidden px-8 text-center text-white">
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{
          backgroundImage: "url('/hero-mockup.jpg')",
        }}
      />

      <div className="absolute inset-0 bg-black/55" />
      <div className="absolute inset-0 bg-gradient-to-b from-black/25 via-black/20 to-[#050505]" />
      ...
      <div className="relative z-10 max-w-5xl pt-20">
        ...
        <FadeIn delay={0.3}>
          <p className="mx-auto mt-8 max-w-2xl text-sm leading-8 text-white/70">
            Select your dates and preferred apartments. Every request is
            reviewed personally before confirmation.
          </p>
        </FadeIn>
      </div>
    </section>
