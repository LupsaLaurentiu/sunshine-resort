export const rooms = [
  {
    ...
    units: ["Apartment 1"],
    shortDescription: "Cel mai mare apartament, dispus pe un singur nivel.",
    description:
    ...
    details: ["Un singur nivel", "Cel mai spațios", "2 adulți", "Baie premium"],
    amenities: ["King Bed", "Smart TV", "Wi-Fi", "Coffee Station", "Private Bathroom"],
  },
  {
    slug: "intimate-apartment",
    title: "Intimate Apartment",
    units: ["Apartment 2"],
    shortDescription: "Cel mai compact apartament, dispus pe un singur nivel.",
    description:
    ...
    details: ["Un singur nivel", "Cel mai intim", "2 adulți", "Ideal pentru cupluri"],
    amenities: ["King Bed", "Smart TV", "Wi-Fi", "Coffee Station", "Private Bathroom"],
  },
  {
    ...
    details: ["Două nivele", "Baie de serviciu", "Bar sub scară", "2 adulți"],
    amenities: ["King Bed", "Smart TV", "Wi-Fi", "Kitchen", "Service Bathroom", "Bar"],
  },
  {
    slug: "premium-apartment",
    title: "Premium Apartment",
    units: ["Apartment 4", "Apartment 5", "Apartment 7", "Apartment 8"],
    shortDescription:
    ...
    details: ["Două nivele", "Două băi", "Dormitor la etaj", "2 adulți"],
    amenities: ["King Bed", "Smart TV", "Wi-Fi", "Kitchen", "Two Bathrooms", "Bar"],
  },
];
